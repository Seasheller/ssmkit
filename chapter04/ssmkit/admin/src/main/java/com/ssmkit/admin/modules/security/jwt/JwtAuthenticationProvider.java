 ...
 * instance of {@link Token} to perform authentication.
 * 
...
public class JwtAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        JwtUserDetails jwtUserDetails = JwtUserDetails.create(subject, authorities);
        
        return new JwtAuthenticationToken(jwtUserDetails, jwtUserDetails.getAuthorities());
    }
